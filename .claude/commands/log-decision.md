...
This task is only executed when a decision changes something already marked LOCKED in PLAN.md.
Steps for this task:
...
2. The entry should contain a heading and answer the following about the decision:
    1. What changed
    2. Why it changed
    3. Which section(s) of PLAN.md this invalidates — name them explicitly by number and title.
    4. Trade-offs / what was given up (if any)
3. In PLAN.md's Status board, find each section named in step 2.3 and change its status from
